      ...
      >
        <div className='relative w-full h-[250px]'>
          <img
            src={image}
            alt='name'
            className='w-full h-full object-cover rounded-2xl text-red-800 '
          />
        ...
        <div className='mt-5'>
          ...
          <p className='mt-2 text-secondary text-[14px]'>{achievement}</p>
        </div>
    ...
    <div className={`mt-12 bg-black-100 rounded-[20px]`}>
      ...
      >
        <motion.div variants={textVariant()}>
          <p className={styles.sectionSubText}>Some other achievements</p>
